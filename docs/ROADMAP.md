...
| Phase 8.16 — H1/H2 AI-only blind preference panel | done | the public blind package now compiles two provider-distinct AI request packs, locks hash-bound raw responses and receipts into nonhuman rows, and routes only primary disputes to a third identity without reading private condition evidence or claiming human validity |
