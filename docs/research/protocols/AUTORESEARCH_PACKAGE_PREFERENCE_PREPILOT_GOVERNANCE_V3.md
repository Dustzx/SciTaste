# Matched idea-to-paper package-preference prepilot governance v3
...
Official DeepSeek documentation names the rolling callable identifier
`deepseek-v4-flash` and the currently documented served release
`DeepSeek-V4-Flash-0731`; the previously recorded `deepseek-flash` /
`DeepSeek-V4.1-Flash` pair is not a launchable provider identity. DeepSeek V4
Flash and GLM-5.3-Flash require separate proposals, hashes, dated pricing
records, authenticated served-model observations, cells, and estimates.
