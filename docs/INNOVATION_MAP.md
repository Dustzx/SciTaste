...
share this object without sharing authority. A later process observation can be
joined to a preserved human intervention while retaining separate intervention
and attribution producers. Candidates remain quarantined until exact outcome
evidence, two independent conflict-cleared reviews, and conditional adjudication
