...
source for the first figure, the draw.io file mirrors its semantic entities for
GUI editing, and the PDF is the publication-rendering asset. The same SVG bytes
are published in the README and project page so the public framework explanation
