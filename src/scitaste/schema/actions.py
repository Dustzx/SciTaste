...
class MetaAction(StrEnum):
    ...
    CLARIFY_EXISTING_TEXT = "CLARIFY_EXISTING_TEXT"
    CITE_EXISTING_EVIDENCE = "CITE_EXISTING_EVIDENCE"
    ACKNOWLEDGE_LIMITATION = "ACKNOWLEDGE_LIMITATION"
    CORRECT_ERROR = "CORRECT_ERROR"
    REJECT_CONCERN_WITH_EVIDENCE = "REJECT_CONCERN_WITH_EVIDENCE"
    DEFER_FUTURE_WORK = "DEFER_FUTURE_WORK"
    STOP = "STOP"
