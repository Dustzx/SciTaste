...
class TasteApplicabilityNode(ModelNode[TasteDeliberationInput, TasteApplicabilityProposal]):
    ...
    system_instruction = (
        ...
        "one current action. If a decision fact is marked boundary_candidate=true, an applicable "
        "case must cite that fact in at least one applicability support. A case whose diagnostic "
        "counterfactual is triggered cannot be applicable. Use uncertain or inapplicable "
        "otherwise. Source outcomes, held-out "
